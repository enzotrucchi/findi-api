...
class MovimientoService
{
     ...
     * Constructor.
     *
     * @param MovimientoRepositoryInterface $movimientoRepository
    ...
    public function obtenerTodos(array $filtros = []): Collection
    {
        ...
        } elseif (isset($filtros['proyecto_id'])) {
            $movimientos = $this->movimientoRepository->obtenerPorProyecto($filtros['proyecto_id']);
        } elseif (isset($filtros['tipo'])) {
            $movimientos = $this->movimientoRepository->obtenerPorTipo($filtros['tipo']);
        } elseif (isset($filtros['status'])) {
            $movimientos = $this->movimientoRepository->obtenerPorStatus($filtros['status']);
        } elseif (isset($filtros['fecha_inicio']) && isset($filtros['fecha_fin'])) {
            $movimientos = $this->movimientoRepository->obtenerPorRangoFechas(
